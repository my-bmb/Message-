...
# SocketIO – no async_mode argument (auto-detected)
...
# ----------------- Run only when executed directly (not via gunicorn) -----------------
if __name__ == '__main__':
    # For local development only – on Render, gunicorn will run the app
