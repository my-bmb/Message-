# IMPORTANT: monkey_patch must be the FIRST line - FOR EVENTLET
import eventlet
...
# SocketIO with eventlet (working on Render.com)
...
def handle_connect():
    ...
    if current_user.is_authenticated:
        ...
        print("⚠️ Anonymous user tried to connect via Socket.IO")
