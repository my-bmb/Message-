...
def get_messages_between(u1, u2, limit=50, offset=0):
...
def chat(user_id):
    ...
    messages = get_messages_between(current_user.id, user_id, limit=50, offset=0)
    for msg in messages:
        if msg.get('is_deleted'):
            msg['content'] = 'This message was deleted'
            msg['message_type'] = 'text'
        msg['formatted_time'] = format_ist_time(msg['created_at'])
        msg['reactions'] = get_reactions_for_message(msg['id'])
...
def load_more_messages():
    ...
    messages = get_messages_between(current_user.id, other_user_id, limit=50, offset=offset)
    for msg in messages:
        if msg.get('is_deleted'):
            msg['content'] = 'This message was deleted'
            msg['message_type'] = 'text'
